...
public class MainWindow extends Application{
	...
	public static final String TEST_CLIPS_PATH = "C:\\Users\\marti\\Google Drive\\Stuff\\Games\\Tabletop\\Atmosfear\\Clips";
		...
		Task<Timeline> timelineTask = new Task<Timeline>(){
			...
			protected Timeline call() throws Exception
			{
				String[] tapePaths = new String[]{
						TEST_CLIPS_PATH + "\\Main Tape\\TestTape.gktape",//};
						TEST_CLIPS_PATH + "\\Booster 1\\TestTape.gktape"};
